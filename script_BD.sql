...
create table Citas (idCita int not null auto_increment constraint Pk_Citas_idCita primary key, policlinica varchar(50) not null, especialidad varchar(30) not null, fechaCita date not null, horaCita time not null, idPaciente varchar(20) not null constraint Fk_Citas_idPaciente foreign key references Pacientes(idPaciente))
...
create table [Admin] (emailAdmin varchar(30) not null, passAdmin varchar(16) not null, nombreAdmin varchar(30) not null)
